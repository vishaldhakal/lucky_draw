# Generated by Django 5.1 on 2024-09-12 10:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_condition', models.ManyToManyField(blank=True, to='offers.electronicoffercondition')),
                ('gift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offers.giftitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offers.giftitem')),
                ('lucky_draw_system', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offers.luckydrawsystem')),
                ('valid_condition', models.ManyToManyField(blank=True, to='offers.mobileoffercondition')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lucky_draw_system', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offers.luckydrawsystem')),
                ('valid_condition', models.ManyToManyField(blank=True, to='offers.rechargecardcondition')),
            ],
            options={
                'ordering': ('start_date',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lucky_draw_system', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='offers.luckydrawsystem')),
            ],
        ),
    ]
